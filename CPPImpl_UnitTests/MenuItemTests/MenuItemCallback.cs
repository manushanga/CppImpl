...
namespace CPPImpl_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new CPPImplPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(mx.CPPImpl.GuidList.guidCPPImplCmdSet, (int)mx.CPPImpl.PkgCmdIDList.GenImpl);
